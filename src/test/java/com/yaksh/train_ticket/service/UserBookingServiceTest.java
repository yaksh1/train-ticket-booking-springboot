...
public class UserBookingServiceTest {
    ...
    public void userBookingService_signUpUser_success(){
        ...
        // Mock behavior: Simulate saving the user. Instead of interacting with the actual database,
        ...
        // Verify that the mocked dependencies were called the expected number of times with the correct parameters
    ...
    public void userBookingService_rescheduleTicket_success(){
        ...
        when(trainService.canBeBooked(any(), any(), any(), any())).thenReturn(new ResponseDataDTO(true,"Can be booked"));
    ...
    public void userBookingService_rescheduleTicket_cannotBeBooked(){
        ...
        when(ticketService.findTicketById(ticketId)).thenReturn(Optional.of(mockTicket));
        when(trainService.canBeBooked(any(), any(), any(), any())).thenReturn(new ResponseDataDTO(false,"Can not be booked"));
    ...
    public void userBookingService_bookTicket_success() {
        ...
        // Act
        ResponseDataDTO response = userBookingService.bookTicket(trainPrn, source, destination, travelDate, seatsToBook);
    ...
    public void userBookingService_bookTicket_userNotLoggedIn() {
        ...
        // Act
        ResponseDataDTO response = userBookingService.bookTicket("train123", "Mumbai", "Delhi", LocalDate.now().plusDays(5), 2);

// To be updated after finishing refactoring
...
//                // Arrange - Setting up test data and mocking dependencies (already initialized
//                // in setup method)
//
...
//
//                // Mock behaviour: Simulate valid email input
//                when(validationChecks.isValidEmail(userEmail)).thenReturn(true);
//                // Mock Behaviour: Simulate user not present
//                when(validationChecks.isUserPresent(userEmail)).thenReturn(false);
//
...
//
//                when(validationChecks.isValidEmail(userEmail)).thenReturn(true);
//                when(validationChecks.isUserPresent(userEmail)).thenReturn(true);
//
//
//                // Act & Assert
//                Assertions.assertThatThrownBy(() -> userBookingService.signupUser(userEmail, password))
//                        .isInstanceOf(CustomException.class);
//
//
//                // Verify interactions
//                verify(validationChecks, times(1)).isValidEmail(userEmail);
//                verify(validationChecks, times(1)).isUserPresent(userEmail);
...
//                when(validationChecks.isValidEmail(userEmail.toLowerCase())).thenReturn(true);

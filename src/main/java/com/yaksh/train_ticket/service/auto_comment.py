        ...
        for line in diff_output.split("\n"):
            ...
            if line.startswith("@@"):
                ...
                if line_num is not None:
                    ...
                    print(f"Added modified line {line_num}: {line[1:]}")  # Debug: Print added line
                    line_num += 1  # Increment line number

        print("Final modified lines list:", modified_lines)  # Debug: Print final modified lines list
